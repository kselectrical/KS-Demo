    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-[170px] right-6 w-14 h-14 bg-gradient-to-br from-[#f97316] to-[#ea580c] hover:from-[#fbbf24] hover:to-[#f97316] text-white rounded-full flex items-center justify-center text-lg z-40 transition-all duration-300 hover:scale-110 shadow-2xl border-0 cursor-pointer"
      ...
      {isOpen && (
        <div className="fixed bottom-[90px] right-6 w-[380px] max-w-[calc(100vw-48px)] h-[520px] max-h-[calc(100vh-140px)] bg-stone-900/95 border border-[rgba(249,115,22,0.25)] rounded-2xl shadow-[0_15px_50px_rgba(0,0,0,0.8)] overflow-hidden z-50 flex flex-col backdrop-blur-md animate-[fadeIn_0.25s_ease-out] select-none">
          ...
          {/* MESSAGES LIST AREA */}
          <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-3.5 bg-stone-950/30 custom-scrollbar">
            {messages.map((msg, index) => (
              ...
              >
                <div
                  className={`p-3.5 rounded-2xl text-xs sm:text-sm leading-relaxed max-w-[85%] shadow-sm ${
                    msg.sender === "user"
